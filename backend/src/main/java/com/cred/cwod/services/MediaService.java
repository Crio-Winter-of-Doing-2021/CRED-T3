...
import com.cred.cwod.exception.DocumentStorageException;
import com.cred.cwod.repositoryServices.MediaRepositoryService;
...
public class MediaService {
  ...
  public String storeFile(MultipartFile file, String userId, String docType) {
    ...
    try {
      ...
      Media doc = mediaRepositoryService.findMediaByCardId(userId);
      if (doc != null) {
